...
function ArtistProfileSkeleton() {
    return (
        <div className="min-h-[calc(100vh-80px)] bg-gallery-cream pt-12 pb-24">
        ...
        <div className="min-h-[calc(100vh-80px)] bg-gallery-cream pt-4 sm:pt-6 pb-12">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <motion.div
                    ...
                    className="relative bg-white rounded-none border border-gallery-charcoal/20 mb-10 overflow-hidden"
                >
                    {/* Cover Banner */}
                    ...
                    <div className="px-6 pb-6 md:px-10 relative">
                        <div className="flex flex-col md:flex-row gap-6 md:gap-10 -mt-10 md:-mt-16">
                            {/* Profile Picture */}
                            <motion.div
                                initial={{ scale: 0.8, opacity: 0 }}
                                animate={{ scale: 1, opacity: 1 }}
                                transition={{ type: "spring", stiffness: 200, damping: 15, delay: 0.2 }}
                                className="w-20 h-20 md:w-32 md:h-32 rounded-none bg-white p-1.5 flex-shrink-0 shadow-none border border-gallery-charcoal/20 mx-auto md:mx-0 relative z-10"
                            >
                            ...
                            >
                                ...
                                {artist.bio && (
                                    <motion.p variants={fadeInUp} className="mt-4 text-gallery-charcoal/80 font-sans text-base md:text-lg leading-relaxed max-w-2xl mx-auto md:mx-0">
                                        {artist.bio}
                                    </motion.p>
                                )}

                                {/* Stats & Actions Action */}
                                <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center md:justify-start gap-3 mt-6">
                                    <div className="bg-gallery-cream px-6 py-3 rounded-none border border-gallery-charcoal/20 text-center min-w-[100px]">
                                        <span className="block text-2xl font-black font-sans text-gallery-black mb-1">
                                            {followerCount}
                                        </span>
                                        <span className="text-[9px] font-bold text-gallery-charcoal/50 uppercase tracking-widest">Followers</span>
                                    </div>
                                    <div className="bg-gallery-cream px-6 py-3 rounded-none border border-gallery-charcoal/20 text-center min-w-[100px]">
                                        <span className="block text-2xl font-black font-sans text-gallery-black mb-1">
                                            {artworks?.length || 0}
                                        </span>
                                        <span className="text-[9px] font-bold text-gallery-charcoal/50 uppercase tracking-widest">Artworks</span>
                                    </div>

                                    {!isOwnProfile && (
                                        <div className="ml-0 md:ml-auto w-full md:w-auto mt-4 md:mt-0">
                                            <Button
                                                ...
                                                className={
                                                    isFollowing
                                                        ? "w-full border-gallery-charcoal/20 text-gallery-charcoal hover:bg-gallery-cream hover:text-gallery-red shadow-none rounded-none h-[62px] px-8 text-xs uppercase tracking-widest font-bold transition-all"
                                                        : "w-full bg-gallery-black hover:bg-gallery-red text-white shadow-none rounded-none h-[62px] px-8 text-xs uppercase tracking-widest font-bold transition-all"
                                                }
                                            >
                ...
                {artworksLoading ? (
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center justify-center py-24 bg-white border border-gallery-charcoal/20 shadow-none mix-blend-multiply"
                    >
                        <Palette className="w-12 h-12 text-gallery-charcoal/20 mb-6" />
                        <h3 className="text-2xl font-sans font-black text-gallery-black mb-3 uppercase tracking-wider">No Artworks Yet</h3>
