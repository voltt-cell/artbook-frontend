        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                    <div>
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-black text-gallery-black uppercase tracking-widest">Artwork Management</h1>
                        <p className="text-gallery-charcoal/70 font-serif italic text-base sm:text-lg mt-2">{totalArtworks} total artworks</p>
                    </div>
